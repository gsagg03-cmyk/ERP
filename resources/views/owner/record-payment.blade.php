...
<div class="min-h-screen w-full px-2 sm:px-4 lg:px-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            ...
            <form action="{{ route('owner.payment.store', $sale->id) }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('owner.due-customers') }}" class="flex-1 text-center bg-gray-500 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded text-lg">
                        বাতিল করুন
                    </a>
                </div>
            </form>
